...
IF OBJECT_ID('dbo.usp_mw_outbound_add_failed_message') IS NOT NULL
    DROP PROCEDURE [dbo].[usp_mw_outbound_add_failed_message];
GO
...
CREATE PROCEDURE [dbo].[usp_mw_outbound_add_failed_message]
...
DECLARE
    ...
    -- Set Constants
    SET @c_vchObjName = N'usp_mw_outbound_add_failed_message';
    SET @c_nErrorLineOffSet = 7;

BEGIN TRY

    INSERT INTO t_mw_outbound_failed_message (
        [mw_outbound_id],
        [wh_id],
        [message_type],
        [order_type],
...
BEGIN CATCH
    ...
    SET @v_vchMsg = N'An error occurred while inserting into t_mw_outbound_failed_message.';
