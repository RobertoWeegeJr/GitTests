...
IF OBJECT_ID('dbo.usp_mw_inbound_add_failed_message') IS NOT NULL
    DROP PROCEDURE [dbo].[usp_mw_inbound_add_failed_message];
GO
...
CREATE PROCEDURE [dbo].[usp_mw_inbound_add_failed_message]
...
DECLARE
    ...
    -- Set Constants
    SET @c_vchObjName = N'usp_mw_inbound_add_failed_message';
