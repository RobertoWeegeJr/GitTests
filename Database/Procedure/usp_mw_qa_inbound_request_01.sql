...
IF OBJECT_ID('dbo.usp_mw_qa_inbound_request_01') IS NOT NULL
    DROP PROCEDURE [dbo].[usp_mw_qa_inbound_request_01];
GO
...
CREATE PROCEDURE [dbo].[usp_mw_qa_inbound_request_01]
AS
...
DECLARE
    ...
    -- Set Constants
    SET @c_vchObjName = N'usp_mw_qa_inbound_request_01';
...
BEGIN
    ...
    BEGIN CATCH
        ...
        SET @v_vchMsg = N'An error occureed while receiving data from q_mw_inbound_request_01.';
