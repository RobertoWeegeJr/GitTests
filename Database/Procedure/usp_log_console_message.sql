...
IF OBJECT_ID('dbo.usp_log_console_message') IS NOT NULL	
	DROP PROCEDURE [dbo].[usp_log_console_message];
GO
...
CREATE PROCEDURE [dbo].[usp_log_console_message] 
	@in_nLogLevel				INT,
...
DECLARE
    ...
    -- Set Constants
    SET @c_vchObjName = N'usp_log_console_message';
