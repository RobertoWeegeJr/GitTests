...
IF OBJECT_ID('dbo.t_mw_outbound_failed_message') IS NULL
BEGIN
    CREATE TABLE [dbo].[t_mw_outbound_failed_message] (
        [mw_outbound_failed_message_id]         BIGINT               IDENTITY,
        ...
        CONSTRAINT [pk_mw_outbound_failed_message]
            PRIMARY KEY ([mw_outbound_failed_message_id])
    );

	CREATE INDEX [i_mw_outbound_failed_message]
